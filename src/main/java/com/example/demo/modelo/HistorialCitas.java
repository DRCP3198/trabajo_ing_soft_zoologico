...
public class HistorialCitas {
	...
	private HistorialClinico clinico;
	...
	public HistorialClinico getClinico() {
		return clinico;
	}

	public void setClinico(HistorialClinico clinico) {
		this.clinico = clinico;
	}

	@Override
	public String toString() {
		return "HistorialCitas [id=" + id + ", fechaIngreso=" + fechaIngreso + ", fechaSalida=" + fechaSalida + "]";
	}
